<div>
    <button class="bg-red rounded-1 w-100 border-0 text-light py-2 mb-5">AGREGAR</button>
    ...
    <div class="collapse" id="categories">
        @foreach ($data as $category)
            <div class="category-container">
                <form method="POST" id="{{ $category->id }}"
                    class="{{ $category->products()->exists() ? 'category' : '' }}">
                    @csrf
