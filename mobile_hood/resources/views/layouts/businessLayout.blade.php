...
<head>
    ...
    <link rel="stylesheet" href="/css/layout/business/styles.css">
    <link rel="stylesheet" href="/css/business/styles.css">
...
<body>
    ...
    @include('components.navs.businessProfile.header', [
        'businessModel' => $businessModel,
        'days' => $days,
        'dayIndex' => $dayIndex,
    ])

    @include('components.navs.businessProfile.scroll.container', [
        'id' => $business['id'],
        'name' => $business['name'],
