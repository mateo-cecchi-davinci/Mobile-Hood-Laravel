                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col col-md-6">{{ __('messages.edit_business') }}</div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('businesses.update', $business) }}"
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="street" class="form-control"
                                        value="{{ $business->street }}" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="number" class="form-control"
                                        value="{{ $business->number }}" required>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <select name="user[]" class="form-select">
                                        ...
                                        @foreach ($users as $user)
                                            <option @selected($business->fk_businesses_users == $user->id) value="{{ $user->id }}">
                                                {{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <select name="category[]" class="form-select" aria-label="Default select example">
                                        ...
                                        @foreach ($categories as $c)
                                            <option @selected($business->category == $c) value="{{ $c }}">
                            ...
                            <input type="hidden" id="lat" name="lat" value="{{ $business->location->lat }}">
                            <input type="hidden" id="lng" name="lng" value="{{ $business->location->lng }}">
